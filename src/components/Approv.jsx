  ...
  const handleSaveClick = () => {
    ...
    Object.keys(selectedOptions).forEach((key) => {
      if (selectedOptions[key] !== "") {
        updatedAnomalies[key] = selectedOptions[key];
      }
    });

    newDataCopy.getAllEvents = {
      ...newDataCopy.getAllEvents,
      ...updatedAnomalies,
    };
    ...
    axios
      .patch(
        `https://ez-group-client-backend.vercel.app/api/v1/event/${id}`,
        newDataCopy.getAllEvents
      )
      .then((response) => {
        if (response.status === 200) {
          ...
          // Update newdata with the saved data
